    ...
    <div>
      ...
      <div className="mt-10 p-5 flex flex-col md:flex-row max-w-5xl mx-auto text-black ">
        <div className=" md:w-1/2">
          ...
          <hr className="w-32 " />
          <h2 className="text-2xl font-semibold">+91 8340268864</h2>
          <p className="text-base mb-3">Book Shows and Movies</p>
          <h2 className="text-2xl font-semibold">contact@ShowsBooking.com</h2>
