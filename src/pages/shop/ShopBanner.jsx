...
const EventBanner = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://s3.ap-southeast-1.amazonaws.com/localiiz-prod/uploads/cny-lunar-new-year-displays-decorations-hong-kong-ifc.jpg?mtime=20210209023619&focal=none')`,
      }}
    >
